...
//I use this function to change the coordinates to be more easy use it
//The coordinates in mouse events are calculated arround the DOM we convert it to use arround the canvas coordinates
